...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.marlonmarqs.promobv.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do PromoBV",
                "Esta API é utilizada para compartilhar suas promoções conforme suas categorias, podendo curtir as promoções e compartilhar.",
                "Versão 2.0",
                "",
                new Contact("Marlon Marques", "", "marlonmarqsbr@gmail.com"),
                "Permitido uso",
                "",
